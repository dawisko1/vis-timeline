...
class Core {
    ...
    _redraw() {
        ...
        if (options.mode === 'vertical') {
            // dom.root.style.transform = 'rotate(90deg)';
        }
    ...
    _setDOM() {
        if (this.options.mode === 'vertical') {
            ...
            dom.backgroundHorizontal.style.width = "70%";
            dom.centerContainer.style.width = "70%";
            dom.leftContainer.style.width = "100%";
            dom.rightContainer.style.width = "100%";
            dom.top.style.width = "30%";
            ...
            dom.backgroundHorizontal.style.left = '30%';
            ...
            dom.centerContainer.style.left = `30%`;
