 ...
 */
  ...
  _onDrag(event) {
    ...
    let delta = (direction == 'horizontal') ? event.deltaX : event.deltaY; // TODO: vertical mode
    ...
    // TODO: vertical mode
    const width = (direction == 'horizontal') ? this.body.domProps.center.width : this.body.domProps.center.height; // TODO: vertical mode
    let diffRange;
